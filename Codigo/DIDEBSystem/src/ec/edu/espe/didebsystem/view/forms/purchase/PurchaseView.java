...
import ec.edu.espe.didebsystem.view.forms.purchase.DeletePurchase;
import ec.edu.espe.didebsystem.view.forms.purchase.SearchPurchaseByID;
import ec.edu.espe.didebsystem.view.forms.purchase.SearchPurchaseByRange;
...
public class PurchaseView extends javax.swing.JFrame {
    ...
    private static PurchaseView form;
    
    public static PurchaseView getInstance(){
        if(form == null) form = new PurchaseView();
        return form;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Administracion de Compras");
        ...
        jMenuItem3.setText("Agregar compra");
        ...
        jMenuItem4.setText("Eliminar compra");
        ...
        jMenuItem5.setText("Búsqueda por ID de compra");
        ...
        jMenuItem6.setText("Búsqueda por rango de fechas");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        AddPurchase form = AddPurchase.getInstance();
        form.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        DeletePurchase form = DeletePurchase.getInstance();
        form.setVisible(true);
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        SearchPurchaseByID form = SearchPurchaseByID.getInstance();
        form.setVisible(true);
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        SearchPurchaseByRange form = SearchPurchaseByRange.getInstance();
        form.setVisible(true);
    ...
    private void loadTable() {
        ...
        dtm.setColumnIdentifiers(
                new String []{"ID de la compra", "Nombre del Proveedor", "Fecha de compra", "Producto/s", "Precio total"}
        );
