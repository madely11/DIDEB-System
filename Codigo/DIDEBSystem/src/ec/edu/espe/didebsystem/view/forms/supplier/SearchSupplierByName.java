 ...
 * @author sebask8er
 */
public class SearchSupplierByName extends javax.swing.JFrame {
    private static SearchSupplierByName form;
    
    public static SearchSupplierByName getInstance(){
        if(form == null) form = new SearchSupplierByName();
        return form;
    }

    private SearchSupplierByName() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Nombre de la fábrica");
        ...
        txtFactoryName.setEnabled(false);
        jPanel1.add(txtFactoryName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, 300, 20));
    ...
    private void listActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listActionPerformed
        if(!this.list.getSelectedItem().toString().equals("Seleccione")){
            ...
            Supplier supplier = DAO.searchSupplierByName(this.list.getSelectedItem().toString());

            this.txtAddress.setText(supplier.getAddress());
            this.txtFactoryName.setText(supplier.getFactory());
    ...
    private void loadList() {
        ...
        for(int i=0; i<suppliers.size(); i++) {
            if(!suppliers.get(i).getName().equals("")){
