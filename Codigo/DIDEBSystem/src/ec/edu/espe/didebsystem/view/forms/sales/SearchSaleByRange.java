 ...
 * @author sebask8er
 */
public class SearchSaleByRange extends javax.swing.JFrame {

    private static SearchSaleByRange form;

    public static SearchSaleByRange getInstance() {
        if (form == null) {
            form = new SearchSaleByRange();
        }
        return form;
    }

    private SearchSaleByRange() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Buscar venta por rango de fechas");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 360, 40));
    ...
    private void loadTable() {
        ...
        for (int i = 0; i < sales.size(); i++) {
            ...
            Integer salesCode = DAO.getSales().get(i).getIdSale();
            ArrayList<Integer> productCodes = DAO.getProductCodesBySaleCode(salesCode);
            ...
            try {
                ...
                Date currentDate = dateFormat2.parse(sales.get(i).getDateSale());
                ...
                Logger.getLogger(SearchSaleByRange.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
