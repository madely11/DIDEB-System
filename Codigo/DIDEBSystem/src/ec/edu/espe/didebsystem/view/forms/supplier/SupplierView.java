...
public class SupplierView extends javax.swing.JFrame {
    private static SupplierView form;
    
    public static SupplierView getInstance(){
        if(form == null) form = new SupplierView();
        return form;
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Fábrica", "Dirección", "Teléfonos"
            }
        ) {
        ...
        jMenuItem6.setText("Búsqueda por fábrica");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        AddSupplier addSupplier = AddSupplier.getInstance();
        addSupplier.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        DeleteSupplier deleteSupplier = DeleteSupplier.getInstance();
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        SearchSupplierByName searchByName = SearchSupplierByName.getInstance();
        searchByName.setVisible(true);
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        SearchSupplierByFactory searchByFactory = SearchSupplierByFactory.getInstance();
        searchByFactory.setVisible(true);
    ...
    private void loadTable() {
        ...
        dtm.setColumnIdentifiers(
                new String []{"Nombre", "Nombre fábrica", "Dirección", "Teléfono/s"}
        );
        ...
        for (int i = 0; i < suppliers.size(); i++) {
            dtm.addRow(
                    new Object []{
                        ...
                        suppliers.get(i).getFactory(),
                        suppliers.get(i).getAddress(),
                        suppliers.get(i).getPhones()
                    }
            );
        }
